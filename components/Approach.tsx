    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description="We'll collaborate to map out your projects's goals, target audience, 
        ...
        <Card
          ...
          coding. I keep you updated every step of the way.">
            <CanvasRevealEffect
                animationSpeed={3}
        ...
        <Card
          ...
          description="This is where the magic happens! Based on the approved design and concept, 
          I'll translate everything into functional code, building project from the ground up."
          >
            <CanvasRevealEffect
                animationSpeed={3}
  ...
  return (
    <div>
        <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[2px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
          ...
          <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-5 py-3 text-white backdrop-blur-3xl text-2xl font-bold">
            {order}
          </span>
        </button>
    </div>
